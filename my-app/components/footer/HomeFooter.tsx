    ...
    <footer className="bg-white dark:bg-primary-950">
      <div className="mx-auto max-w-7xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="flex justify-center text-secondary-600 sm:justify-start dark:text-secondary-300">
              <Image
                src={"/images/logo.png"}
                width={60}
                height={60}
            ...
            <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-secondary-700 transition hover:text-secondary-700/75 dark:text-secondary-500 dark:hover:text-secondary-500/75"
                >
        ...
        <div className="mt-12 border-t border-gray-100 pt-6 dark:border-gray-800">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            <p className="text-sm text-gray-500 dark:text-gray-400">
              ...
              <a
                className="inline-block text-secondary-600 underline transition hover:text-secondary-600/75 dark:text-secondary-500 dark:hover:text-secondary-500/75"
                href="#"
              >
                Terms &amp; Conditions
              </a>
